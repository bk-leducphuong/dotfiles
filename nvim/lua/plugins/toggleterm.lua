 return {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>t1", "<cmd>1ToggleTerm direction=horizontal<CR>", { desc = "Terminal 1" })
      vim.keymap.set("n", "<leader>t2", "<cmd>2ToggleTerm direction=horizontal<CR>", { desc = "Terminal 2" })
      vim.keymap.set("n", "<leader>t3", "<cmd>3ToggleTerm direction=horizontal<CR>", { desc = "Terminal 3" })
      vim.keymap.set("n", "<leader>t4", "<cmd>4ToggleTerm direction=horizontal<CR>", { desc = "Terminal 4" })
      vim.keymap.set("n", "<leader>t5", "<cmd>5ToggleTerm direction=horizontal<CR>", { desc = "Terminal 5" })
